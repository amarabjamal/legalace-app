                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-6 py-4 text-right">
                            <Link :href="`/clerks/${ clerk.id }/edit`" class="font-medium text-blue-600 hover:underline">Edit</Link>
                            <Link @click="deleteClerk(clerk)" as="button" class="ml-3 font-medium text-red-600 hover:underline">Delete</Link>
                        </td>
                    </tr>
                </tbody>
            </table>
...
export default { 
    ...
    methods: {
        deleteClerk(clerk) {
            if (confirm('Are you sure you want to delete this clerk account?')) {
                Inertia.delete(`/clerks/${ clerk.id }`);
            }
        }
    },
