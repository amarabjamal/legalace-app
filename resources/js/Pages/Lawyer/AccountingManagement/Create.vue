        ...
        <form @submit.prevent="store">
            <div class="p-8 space-y-12">
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    />
                    <select-input
                        v-model="form.approver_user_id"
                        :error="form.errors.approver_user_id"
                        label="Approver"
                        required
                    >
                ...
                <div class="w-full overflow-x-auto overflow-y-hidden">
                    ...
                    >
                        ...
                        <tbody>
                            <tr
                                v-for="(added_item, index) in added_items"
                                :key="index"
                            ...
                            >
                                ...
                                <td
                                    class="px-0 py-2 align-top text-right tabular-nums"
                                >
                            ...
                            >
                                ...
                                >
                                    <div
                                        v-if="$page.props.errors.item_id"
                                        class="form-error"
                                    >
                                        {{ $page.props.errors.item_id }}
                                    </div>
                            ...
                            <tr class="border border-gray-300">
                                <td colspan="100">
                                    <div
                                        class="w-100 flex justify-center px-4 py-2"
                                    >
                                        <button
                                            type="button"
                                            class="select-none text-gray-700 text-sm font-medium"
                                            @click="openModal"
                                        >
                                            + Add Item
                                        </button>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td
                                    colspan="1"
                                    class="py-2 text-right font-semibold tabular-nums text-gray-900 border-b border-gray-300 bg-gray-100"
                                >
                                    {{ $filters.currency(total) }}
                                </td>
                                <td
                                    class="border-b border-r border-gray-300 bg-gray-100"
                                ></td>
                            </tr>
                        </tfoot>
                    </table>
    ...
    methods: {
        ...
        addItem(id) {
            if (this.isAdded(id)) {
                ...
                this.reimbursable_items.find((item) => item.id === id) !=
                undefined
            ) {
                const new_item = this.reimbursable_items.find(
                    (item) => item.id === id,
                );
