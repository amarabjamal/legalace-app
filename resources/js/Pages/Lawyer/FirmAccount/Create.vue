                    ...
                    <form @submit.prevent="submit">
                        ...
                        /> -->
                            ...
                            <p
                                ...
                                v-text="form.errors.transaction_type"
                                class="mt-2 text-sm text-red-600 dark:text-red-500"
                            ></p>
                        </div>
                        <div class="mb-6">
                            ...
                            />
                            <p
                                v-if="form.errors.debit"
                                v-text="form.errors.debit"
                                class="mt-2 text-sm text-red-600 dark:text-red-500"
                            ></p>
                        </div>
                        <div class="mb-6">
                            ...
                            />
                            <p
                                v-if="form.errors.credit"
                                v-text="form.errors.credit"
                                class="mt-2 text-sm text-red-600 dark:text-red-500"
                            ></p>
                        </div>
                        <div class="mb-6">
                            ...
                            <p
                                ...
                                v-text="form.errors.bank_account_id"
                                class="mt-2 text-sm text-red-600 dark:text-red-500"
                            ></p>
                        </div>
