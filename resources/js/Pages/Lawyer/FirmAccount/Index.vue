<template>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-3 mt-4">
        <div v-for="bank_account in bank_accounts.data" :key="bank_account.id" class="min-w-0 bg-white border border-gray-300 rounded-md overflow-hidden ease-in-out duration-300 hover:shadow-md hover:scale-105 hover:-translate-y-5">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-6 py-4 text-right">
                            <Link :href="`/firm-account/${ acc.id }/edit`" class="font-medium text-blue-600 hover:underline">Edit</Link>
