    ...
    <section class="dashboard">
        ...
        <div class="top">
            <div class="flex items-center">
                <icon v-if="!isSidebarOpen" @click="toggleSidebar" name="menu-line" class="sidebar-toggle-button"></icon>
                <icon v-else @click="toggleSidebar" name="menu-fold-fill" class="sidebar-toggle-button"></icon>
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                >
                    ...
                    <!-- Notification badge -->
                    <span aria-hidden="true" class="notification-badge"></span>
                </button>
                <transition
                ...
                >
                    ...
                    <div class="auth-nav">
                        ...
                        <p class="auth-role">
                            ...
                            <span v-else class="capitalize">{{ auth.user.roles }}</span>
                        </p>
                    </div>
                </button>
                <transition
                ...
                >
                    <template v-if="isProfileMenuOpen">
                        ...
                        >
                        <li class="flex">
                            <Link as="a" href="/lawyer/profile" class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                            <svg
                                class="w-4 h-4 mr-3"
                                aria-hidden="true"
                                fill="none"
                        ...
                        <li class="flex">
                            <Link as="a" href="/lawyer/setting" class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                            <svg
                                class="w-4 h-4 mr-3"
                                aria-hidden="true"
                                fill="none"
