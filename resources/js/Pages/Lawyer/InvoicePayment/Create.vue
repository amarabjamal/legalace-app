    ...
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
        <form @submit.prevent="store">
            <div class="flex flex-wrap -mb-8 -mr-6 p-8">
                ...
                <select-input v-model="form.payment_method_code" :error="form.errors.payment_method_code" class="pb-8 pr-6 w-full lg:w-1/2" label="Payment Method" required>
    ...
    data() {
        return {
            ...
            breadcrumbs: [
                ...
                { link: null, label: 'Add Payment' },
            ],
        }
    },
    methods: {
        store() {
            this.form.post(`/lawyer/case-files/${this.case_file.id}/invoices/${this.invoice.id}/payment`, {forceFormData: true,});
        },
    },
}
