                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-right">
                                    <Link :href="`/operational-cost/${ cost.id }/edit`" class="font-medium text-blue-600 hover:underline">Edit</Link>
...
export default { 
    setup(props) {
        let searchCosts = ref(props.filters.search);

        watch(searchCosts, throttle(value => {
