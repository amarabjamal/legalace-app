<template>
    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
        <table class="w-full whitespace-nowrap">
            ...
            <tr>
                <td v-if="disbursement_items.data.length === 0" class="px-6 py-4 border-t text-center text-slate-500 bg-slate-100" colspan="100%">No records found.</td>
            </tr>
            </tbody>
        </table>
    </div>
        ...
        statusClass(status) {
            ...
            variants: {
                    status: {
                        ...
                        Invoiced: "text-orange-800 bg-orange-200",
                        Paid: "text-blue-800 bg-blue-200",
                        Claiming: "text-yellow-800 bg-yellow-200",
                        'Pending Approval': "text-orange-800 bg-orange-200",
                        Approved: "text-purple-800 bg-purple-200",
                        Disbursed: "text-green-800 bg-green-200",
                        Denied: "text-red-800 bg-red-200",
                    }
                }
            }) ({
                status: status,
