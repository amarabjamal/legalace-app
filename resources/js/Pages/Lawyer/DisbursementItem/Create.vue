<template>
    ...
    <add-record-type-modal
        :isOpen="show_add_record_type_modal"
        @close-modal="show_add_record_type_modal = false"
    />
        ...
        <form @submit.prevent="store">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    >
                        <div class="space-y-2">
                            ...
                            <button
                                @click="show_add_record_type_modal = true"
                                type="button"
            ...
            >
                <loading-button
                    ...
                    class="btn-primary"
                    type="submit"
                    >Create Item</loading-button
                >
                <Link
                    :href="`/lawyer/case-files/${this.case_file.id}/disbursement-items`"
                    as="button"
                    class="btn-cancel"
    ...
    methods: {
        store() {
            if (this.form.isDirty) {
                ...
                this.form.post(
                    `/lawyer/case-files/${this.case_file.id}/disbursement-items`,
                    { forceFormData: true },
                );
            } else {
