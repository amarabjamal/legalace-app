<template>
    <Head title="Account Reporting" />
    <Sidebar/>

    <div class="flex flex-col flex-1">
        <Header title="Account Reporting" />
        ...
        <!-- <div class="grid gap-6 mb-8 md:grid-cols-2">
                <div class="min-w-0 p-4 bg-white  shadow-xs dark:bg-gray-800">
                    <div v-for="bankAccount in bankAccounts" class="min-w-0 p-4 bg-white  shadow-xs dark:bg-gray-800">
                        ...
                        {{ bankAccount.account_name }}Megat Holding
                        </h4>
                ...
                <div class="w-1/2 relative overflow-x-auto shadow-md sm:rounded-lg content-center">
                    <!-- <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            <tr 
                                v-for="acc in accountReporting.data"
                                :key="acc.id"
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-right">
                                    <Link :href="`/account-reporting/${ acc.id }/edit`" class="font-medium text-blue-600 hover:underline">Edit</Link>
...
export default { 
    setup(props) {
        ...
        watch(searchClients, throttle(value => {
            Inertia.get('/account-reporting', { search: value }, {
                preserveState: true,
                replace: true,
            });
        }, 500));
    ...
    //             Inertia.delete(`/account-reporting/${ acc.id }`);
    //         }
    //     }
    // },
};
