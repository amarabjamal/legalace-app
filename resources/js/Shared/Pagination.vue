<template>
    ...
    >
        <span v-if="total != 0" class="text-sm text-gray-700 mr-5">
            Showing
            <span class="font-semibold text-primary">{{ from }}</span> to
            <span class="font-semibold text-primary">{{ to }}</span> of
            <span class="font-semibold text-primary">{{ total }}</span> Entries
        </span>
        <span v-else class="text-sm text-gray-700 mr-5">
            Showing
            <span class="font-semibold text-primary">{{ total }}</span> Entries
        </span>
